...
private:
	...
	std::wstring ConvToWString(const std::string& text);
	std::wstring TrimRight(const std::wstring& str, const std::wstring& trimChars = L" \t\r\n");
	std::wstring TrimLeft(const std::wstring& str, const std::wstring& trimChars = L" \t\r\n");
	std::wstring Trim(const std::wstring& str, const std::wstring& trimChars = L" \t\r\n");
